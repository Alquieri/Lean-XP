...
namespace LeanXP.Server.Services;
...
public class AchievementService
{
    ...
    public async Task<Achievement> CreateAchievement(AchievementCreateDto achievementDto)
    {
        ...
        if (!System.IO.File.Exists(achievementDto.Image))
        {
        ...
        var imageBytes = await System.IO.File.ReadAllBytesAsync(achievementDto.Image);
